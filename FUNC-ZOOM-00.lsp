...
;;;++ DESCRI��O: ZOOM A PATIR DE UM PONTO COM UM RAIO SOLICITADO
...
;;;++ DESCRI��O: ZOOM ENTRE VARIOS PONTOS DE UMA LISTA AUMENTANDO A �REA EM FUN��O DE PREC
;;;++ ENTRADA: LISTA COM OS PONTOS E A PRECIS�O
;;;++ SAIDA: ZOOM NA TELA
...
;;;<> ESHOP-GRDRAW_LST   
;;;++ DESCRI��O: CRIA GRDRAW TELA A PARTIR DE LISTA DE PONTOS
